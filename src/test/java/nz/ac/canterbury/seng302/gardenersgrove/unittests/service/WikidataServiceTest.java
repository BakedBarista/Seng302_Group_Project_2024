...
class WikidataServiceTest {
    ...
    void givenPlantExists_whenSearchTomato_thenReturnInformationAndImage() throws Exception {
        ...
        JsonNode expected = objectMapper.readTree("{\"plants\":[{\"label\":\"Tomato\",\"description\":\"A red fruit\",\"id\":\"Q235\",\"image\":\"https://commons.wikimedia.org/wiki/Special:FilePath/Tomato.jpg\",\"formatted\":\"Tomato &ndash; <em>A red fruit</em>\"}]}");
