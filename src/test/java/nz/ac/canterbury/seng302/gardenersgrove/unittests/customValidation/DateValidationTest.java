...
public class DateValidationTest {
    ...
    @Test
    void givenDateIsInTheThymeleafFormat_AndMonthIsTooLarge_ReturnTrue() {
    ...
    @Test
    void givenDateIsInThePersistedFormat_AndMonthIsTooLarge_ReturnTrue() {
    ...
    void givenDateIsInTheThymeleafFormat_AndDayIsTooLarge_ReturnTrue(String date) {
        boolean isValid = dateValidator.isValid(date, context);
    ...
    void givenDateIsInThePersistedFormat_AndDayIsTooLarge_ReturnTrue(String date) {
        boolean isValid = dateValidator.isValid(date, context);
