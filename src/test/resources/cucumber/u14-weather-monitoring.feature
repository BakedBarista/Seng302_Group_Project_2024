Feature: U14 As Kaia, I want to know the current and future weather at my gardens, so I know if I need to water them
  ...
  Background:
    ...
    And I create a garden called "My Secret Garden" in "Christchurch", "New Zealand"
    And I create a garden called "Top Secret Garden" in "unknown", "nz"
  ...
  Scenario: AC1 Display the current weather
    Given I am on the garden details page for "My Secret Garden"
  ...
  Scenario: AC3 Error message for unknown location
    Given I am on the garden details page for "Top Secret Garden"
