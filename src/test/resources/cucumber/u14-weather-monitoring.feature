Feature: U14 As Kaia, I want to know the current and future weather at my gardens, so I know if I need to water them
  ...
  Scenario: AC1 Display the current weather
    Given I create a garden called "My Secret Garden" in "Christchurch", "New Zealand"
    When I am on the garden details page for "My Secret Garden"
  ...
  Scenario: AC3 Error message for unknown location
    Given I create a garden called "Top Secret Garden" in "unknown", "nz"
    When I am on the garden details page for "Top Secret Garden"
